...
<body>
       {{--layout start--}}
                    <div class="easyui-panel" style="margin-left:30%; margin-top:5%;" data-options="fit:true,border:false">
                        <div class="easyui-panel" title="Reset Password" style="width:400px;padding:30px 70px 20px 70px">
                            {{Form::open( array('route'=>'change_pass','method'=>'POST','ajax'=>'true','id'=>'pass_form'))}}
                            ...
                            <div style="margin-bottom:20px">
                        			<input class="easyui-textbox" type="password" name="password" style="width:100%;height:40px;padding:12px" data-options="prompt:'New Password',iconCls:'icon-lock',iconWidth:38,required:true">
                        		</div>
                            <div style="margin-bottom:20px">
                        		...
                        		<div>
                        			<a href="#" class="easyui-linkbutton" onclick="updatePass()" data-options="iconCls:'icon-ok'" style="padding:5px 0px;width:100%;">
