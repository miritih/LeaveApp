		...
		function initCss(){
			if (!$('#datagrid-group-style').length){
				$('head').append(
					...
					'.datagrid-group{height:'+opts.groupHeight+'px;background:#E0ECFF;overflow:hidden;font-weight:bold;font-size:16px;border-bottom:1px solid #ccc;}' +
					'.datagrid-group-title,.datagrid-group-expander{display:inline-block;vertical-align:bottom;height:100%;line-height:'+opts.groupHeight+'px;padding:0 30px;}' +
